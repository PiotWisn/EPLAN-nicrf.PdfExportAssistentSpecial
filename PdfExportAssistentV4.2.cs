...
public partial class frmPDFAssistent : System.Windows.Forms.Form
{
	...
	private Button btnGetPdflinkremover;
	...
	private CheckBox chkWithlink;
	private CheckBox chkExportByPorperty;
	...
	private Label lGetPdflinkremover;
	...
	private TextBox txtGetPdflinkremover;
	...
	private void InitializeComponent()
	{
			...
			this.btnGetPdflinkremover = new System.Windows.Forms.Button();
			...
			this.chkWithlink = new System.Windows.Forms.CheckBox();
			this.chkExportByPorperty = new System.Windows.Forms.CheckBox();
			...
			this.lGetPdflinkremover = new System.Windows.Forms.Label();
			...
			this.txtGetPdflinkremover = new System.Windows.Forms.TextBox();
			...
			this.chkEinstellungSpeichern.Text = "Save Settings";
			...
			this.tabPage1.Controls.Add(this.chkBlackandwhite);
			this.tabPage1.Controls.Add(this.cboAusgabeNach);
			this.tabPage1.Controls.Add(this.chkWithlink);
			//this.tabPage1.Controls.Add(this.chkExportByPorperty);
			...
			this.chkDatumStempel.Text = "Date Stamps";
			...
			this.chkZeitStempel.Text = "Time Stamp";
			...
			this.chkBlackandwhite.Location = new System.Drawing.Point(20, 174);
			this.chkBlackandwhite.Name = "chkBlackandwhite";
			this.chkBlackandwhite.Size = new System.Drawing.Size(85, 17);
			this.chkBlackandwhite.TabIndex = 11;
			this.chkBlackandwhite.Text = "Black and white";
			this.chkBlackandwhite.UseVisualStyleBackColor = true;
			this.chkZeitStempel.CheckedChanged += new System.EventHandler(this.chkBlackandwhite_CheckedChanged);		
			//
			// chkWithlink
			//
			this.chkWithlink.AutoSize = true;
			this.chkWithlink.Location = new System.Drawing.Point(150, 174);
			this.chkWithlink.Name = "chkWithlink";
			this.chkWithlink.Size = new System.Drawing.Size(85, 17);
			this.chkWithlink.TabIndex = 11;
			this.chkWithlink.Text = "With link";
			this.chkWithlink.UseVisualStyleBackColor = true;
			this.chkWithlink.CheckedChanged += new System.EventHandler(this.chkWithlink_CheckedChanged);		
			//			
			// chkExportByPorperty
			//
			this.chkExportByPorperty.AutoSize = true;
			this.chkExportByPorperty.Location = new System.Drawing.Point(230, 174);
			this.chkExportByPorperty.Name = "chkWithExportBy";
			this.chkExportByPorperty.Size = new System.Drawing.Size(85, 17);
			this.chkExportByPorperty.TabIndex = 11;
			this.chkExportByPorperty.Text = "Export by property";
			this.chkExportByPorperty.UseVisualStyleBackColor = true;
			this.chkExportByPorperty.CheckedChanged += new System.EventHandler(this.chkExportByPorperty_CheckedChanged);				
			// 
			// cboAusgabeNach
			// 
            ...
            "Output directory Settings: PDF export",
            "in the folder one level above the project folder",
            "in Order \"My Documents\"",
            "on the Desktop",
            "the same path as the project only to another drive"});
			...
			this.label4.Text = "PDF-Filename expand:";
			// 
			// label3
			// 
			...
			this.label3.Text = "PDF-File name (without extension (.pdf)):";
			// 
			// label2
			// 
			...
			this.chkIstInProjektOrdner.Text = "if project in this folder";
			...
			this.chkOhneNachfrage.Text = "directly (without prompting)";
			...
			this.groupBox1.Controls.Add(this.btnGetPdflinkremover);
			this.groupBox1.Controls.Add(this.lGetPdflinkremover);
			this.groupBox1.Controls.Add(this.txtGetPdflinkremover);
			...
			// lGetPdflinkremover
			// 
			this.lGetPdflinkremover.AutoSize = true;
			this.lGetPdflinkremover.Location = new System.Drawing.Point(206, 10);
			this.lGetPdflinkremover.Name = "lGetPdflinkremover";
			this.lGetPdflinkremover.Size = new System.Drawing.Size(79, 13);
			this.lGetPdflinkremover.TabIndex = 9;
			this.lGetPdflinkremover.Text = "Pdf link remover path";
			// 
			// btnGetPdflinkremover
			// 
			this.btnGetPdflinkremover.Location = new System.Drawing.Point(442, 30);
			this.btnGetPdflinkremover.Name = "btnGetPdflinkremover";
			this.btnGetPdflinkremover.Size = new System.Drawing.Size(28, 20);
			this.btnGetPdflinkremover.TabIndex = 16;
			this.btnGetPdflinkremover.Text = "...";
			this.btnGetPdflinkremover.UseVisualStyleBackColor = true;
			this.btnGetPdflinkremover.Click += new System.EventHandler(this.btnGetPdflinkremover_Click);
			// 
			// txtGetPdflinkremover
			// 
			this.txtGetPdflinkremover.Location = new System.Drawing.Point(206, 30);
			this.txtGetPdflinkremover.Name = "txtGetPdflinkremover";
			this.txtGetPdflinkremover.Size = new System.Drawing.Size(230, 20);
			this.txtGetPdflinkremover.TabIndex = 5;
			this.txtGetPdflinkremover.Enabled = false;
			// 
			// chkByEplanEnd
			// 
			...
			this.chkByEplanEnd.Text = "if Eplan is terminated";
			...
			this.Text = "PDF-Export (Assistant) V4";
	...
	public void PDFAssistent_Menu()
	{
		...
		oMenu.AddMenuItem("PDF (Assistant)V4...", "PDFAssistent_Start", "PDF Assistant, Export current project as a PDF file", 35287, 1, false, false);
	}
	...
	private void btnAbbrechen_Click(object sender, System.EventArgs e)
	{
		...
		//Button: Abbrechen
	private void btnGetPdflinkremover_Click(object sender, System.EventArgs e)
	{
        OpenFileDialog openFileDialog1 = new OpenFileDialog();

               openFileDialog1.Filter = "PDFLinkRemover.exe |PDFLinkRemover.exe|All files (*.*)|*.*" ;
        openFileDialog1.RestoreDirectory = true ;

        if(openFileDialog1.ShowDialog() == DialogResult.OK)
	    {
           // OpenProject(openFileDialog1.FileName.ToString()); // Kommentar
           txtGetPdflinkremover.Text = openFileDialog1.FileName.ToString();
	    }      
        return;
	}
	//Button: OK
	...
	private void cboAusgabeNach_SelectedIndexChanged(object sender, EventArgs e)
	{
		...
		switch (cboAusgabeNach.SelectedIndex)
		{
			...
			case 2: //in den Ordner eine Ebene über dem Projekt-Ordner
				sAusgabeOrdner = sProjektOrdner.Substring(0, sProjektOrdner.LastIndexOf(@"\")) +@"\PDF";
				break;
	...
	//Zeitstempel zustand hat sich geändert
	private void chkWithlink_CheckedChanged(object sender, EventArgs e)
	{ 
		cboAusgabeNach_SelectedIndexChanged(sender, e);
	}
	...
	//Zeitstempel zustand hat sich geändert
	private void chkExportByPorperty_CheckedChanged(object sender, EventArgs e)
	{ 
		cboAusgabeNach_SelectedIndexChanged(sender, e);
	}
	...
	{
        string filepath = Path.GetDirectoryName(sZielDatei);
        DirectoryInfo d = new DirectoryInfo(filepath);
        
        if (!Directory.Exists(filepath + "\\Archives\\"))
		{
		    Directory.CreateDirectory(filepath + "\\Archives\\");
		}
        
        foreach (var file in d.GetFiles("*.pdf"))
        {
            if(!IsFileinUse(file)) 
                Directory.Move(file.FullName, filepath + "\\Archives\\" + file.Name);
        }
        /*string path =System.IO.Path.GetDirectoryName(sZielDatei);
		...
		if (chkExportByPorperty.Checked)
		{
			pdfContext.AddParameter("PDFPROJECTSCHEME ", sZielDatei); 
			pdfContext.AddParameter("PDFPAGESSCHEME ", sZielDatei); 
		}
		else
		{
		...
		if (chkBlackandwhite.Checked)
		{
			pdfContext.AddParameter("blackwhite", "2"); //2 = Grayscale
		}
		else
		{
			pdfContext.AddParameter("blackwhite", "0"); //0=Color
		}
		pdfContext.AddParameter("CONFIGSCHEME", "Default");
		...
		if (!chkWithlink.Checked)
		{
			string cmdpath = txtGetPdflinkremover.Text;
			if (!string.IsNullOrEmpty(cmdpath))
		    {
				if (File.Exists(cmdpath))
			    {
						try
				        {
				            Process.Start(cmdpath, "\""+ sZielDatei +"\"");
				        }
				        catch (Exception ex)
				        {
				            MessageBox.Show(
				...
				MessageBox.Show("Set PDF Remover Link Path!");
		}
		/*p.StartInfo.FileName = "P:\\PDFLinkRemover\\PDFLinkRemover.exe";
		p.StartInfo.Arguments = "\""+ sZielDatei +"\"";
		p.Start();
        */
		return;
	}
	...
	public void WriteSettings()
	{
		...
		if (chkEinstellungSpeichern.Checked)
		{
			...
			//White and black
			if (!oSettings.ExistSetting("USER.SCRIPTS.PDF_Assistent.Blackandwhite"))
			{
				oSettings.AddBoolSetting("USER.SCRIPTS.PDF_Assistent.Blackandwhite",
					new bool[] { false },
					"Black and white export",
					new bool[] { false },
					ISettings.CreationFlag.Insert);
			}
			oSettings.SetBoolSetting("USER.SCRIPTS.PDF_Assistent.Blackandwhite", chkBlackandwhite.Checked, 1); //1 = Visible = True

			//With link
			if (!oSettings.ExistSetting("USER.SCRIPTS.PDF_Assistent.WithLink"))
			{
				oSettings.AddBoolSetting("USER.SCRIPTS.PDF_Assistent.WithLink",
					new bool[] { false },
					"With Link export",
					new bool[] { false },
					ISettings.CreationFlag.Insert);
			}
			oSettings.SetBoolSetting("USER.SCRIPTS.PDF_Assistent.WithLink", chkWithlink.Checked, 1); //1 = Visible = True
			
			
			//ExportByProperty
			if (!oSettings.ExistSetting("USER.SCRIPTS.PDF_Assistent.ExportByProperty"))
			{
				oSettings.AddBoolSetting("USER.SCRIPTS.PDF_Assistent.ExportByProperty",
					new bool[] { false },
					"With Link export",
					new bool[] { false },
					ISettings.CreationFlag.Insert);
			}
			oSettings.SetBoolSetting("USER.SCRIPTS.PDF_Assistent.ExportByProperty", chkExportByPorperty.Checked, 1); //1 = Visible = True	
			...
			//txtGetPdflinkremover.Text PathPdflinkremover
			
			if (!oSettings.ExistSetting("USER.SCRIPTS.PDF_Assistent.PathPdflinkremover"))
			{
				oSettings.AddStringSetting("USER.SCRIPTS.PDF_Assistent.PathPdflinkremover",
				new string[] { },
				new string[] { }, "test setting",
				new string[] { "Default value of test setting" },
				ISettings.CreationFlag.Insert);
			}
			oSettings.SetStringSetting("USER.SCRIPTS.PDF_Assistent.PathPdflinkremover", txtGetPdflinkremover.Text, 0);
		}
	}
	...
	public void ReadSettings()
	{
		...
		if (oSettings.ExistSetting("USER.SCRIPTS.PDF_Assistent.PathPdflinkremover"))
		{
			txtGetPdflinkremover.Text = oSettings.GetStringSetting("USER.SCRIPTS.PDF_Assistent.PathPdflinkremover", 0);
		}
		
		//With link
		if (oSettings.ExistSetting("USER.SCRIPTS.PDF_Assistent.WithLink"))
		{
			chkWithlink.Checked = oSettings.GetBoolSetting("USER.SCRIPTS.PDF_Assistent.WithLink", 1);
		}
		...
		if (oSettings.ExistSetting("USER.SCRIPTS.PDF_Assistent.Blackandwhite"))
		{
			chkBlackandwhite.Checked = oSettings.GetBoolSetting("USER.SCRIPTS.PDF_Assistent.Blackandwhite", 1);
		}
		
		//ExportByProperty
		if (oSettings.ExistSetting("USER.SCRIPTS.PDF_Assistent.ExportByProperty"))
		{
			chkExportByPorperty.Checked = oSettings.GetBoolSetting("USER.SCRIPTS.PDF_Assistent.ExportByProperty", 1);
		}
